...
<body>
    <div class="jumbotron jumbotron-fluid" style="background-color:#ca579e;">
...
<body>
    ...
    <div class="jumbotron jumbotron-fluid " style="background-color:rgb(252, 193, 117); ">
...
```
## OUTPUT:
![output](./static/img/predictL.png)
![output](./static/img/predictM.png)
![output](./static/img/trainL.png)
![output](./static/img/trainM.png)
![output](./static/img/terminal.png)


## VALIDATION REPORT:

![output](./static/img/PredictV.png)
![output](./static/img/TrainV.png)

## RESULT:
```
Thus a website is designed for the house price model and is hosted in the 
URL: http://sanjay.student.saveetha.in:8000/HouseModelTraining/.
URL: http://sanjay.student.saveetha.in:8000/HouseModelPrediction/. HTML code is validated.